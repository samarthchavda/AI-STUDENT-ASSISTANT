...
# Read markdown
with open('Full_Stack_Interview_Questions_Answers.md', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# Create PDF
pdf_file = 'Full_Stack_Interview_Questions_Answers.pdf'
...
title_style = ParagraphStyle('CustomTitle', parent=styles['Heading1'],
    fontSize=22, textColor=HexColor('#1a5490'), spaceAfter=20, spaceBefore=10, leading=28)

subtitle_style = ParagraphStyle('CustomSubtitle', parent=styles['Heading2'],
    fontSize=14, textColor=HexColor('#2c5f8d'), spaceAfter=15, spaceBefore=5, leading=18)
...
# Build PDF
print("🔄 Generating Full Stack Interview Q&A PDF...")
doc.build(elements)
