...
const toolCards: ToolCard[] = [
  {
    ...
    description: '10 FREE Questions • Previous Year Papers from TCS, Infosys, Wipro, Amazon, Microsoft, Google',
    route: '/practice-aptitude',
    icon: Target,
    accent: 'from-gradient-to-r from-purple-100 to-blue-100 border-purple-300'
  },
  {
    id: 'aptitude-tests',
